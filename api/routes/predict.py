...
BASE = os.path.join(BASE_DIR, "models", "saved")
model          = joblib.load(os.path.join(BASE, "inventory_model.pkl"))
le_category    = joblib.load(os.path.join(BASE, "le_category.pkl"))
le_region      = joblib.load(os.path.join(BASE, "le_region.pkl"))
le_weather     = joblib.load(os.path.join(BASE, "le_weather.pkl"))
le_seasonality = joblib.load(os.path.join(BASE, "le_seasonality.pkl"))
